...
{
    /// <inheritdoc />
    public partial class vaxSchedulerMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VaccinationCenters", x => x.CenterId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CenterId = table.Column<int>(type: "int", nullable: false),
                    TimeGapBetweenDoses = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VaccineId = table.Column<int>(type: "int", nullable: false),
                    CertificateFilePath = table.Column<byte[]>(type: "varbinary(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificates_AspNetUsers_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VaccineId = table.Column<int>(type: "int", nullable: false),
                    CenterId = table.Column<int>(type: "int", nullable: false),
                    DoseNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_VaccinationCenters_CenterId",
                        column: x => x.CenterId,
                        principalTable: "VaccinationCenters",
                        principalColumn: "CenterId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Reservations_Vaccines_VaccineId",
                        column: x => x.VaccineId,
                        principalTable: "Vaccines",
                        principalColumn: "VaccineId",
                        onDelete: ReferentialAction.NoAction);
